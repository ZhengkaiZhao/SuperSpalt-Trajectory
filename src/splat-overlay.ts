...
class SplatOverlay extends Element {
    ...
    attach(splat: Splat) {
        ...
        // The legacy centers overlay consumes the CPU sort order texture. The
        // unified WebGPU renderer has no such texture; the normal Gaussian
        // view remains active and selection is colored in its work buffer.
