...
import { CameraParametersPanel } from './camera-parameters-panel';
...
import { TrajectoryPlannerPanel } from './trajectory-planner-panel';
...
class EditorUI {
    ...
    constructor(events: Events) {
        ...
        const cameraParametersPanel = new CameraParametersPanel(events);
        const trajectoryPlannerPanel = new TrajectoryPlannerPanel(events);
        const performanceHud = new PerformanceHud(events);

        canvasContainer.dom.appendChild(canvas);
        canvasContainer.append(appLabel);
        canvasContainer.append(cameraInfoOverlay);
        canvasContainer.append(performanceHud);
        canvasContainer.append(cameraParametersPanel);
