    ...
    plugins: [
        copyAndWatch({
            targets: [
                ...
                { src: 'node_modules/@webgpu/glslang/dist/web-devel/glslang.js', dest: 'static/lib/glslang' },
                { src: 'node_modules/@webgpu/glslang/dist/web-devel/glslang.wasm', dest: 'static/lib/glslang' },
                { src: 'node_modules/@babylonjs/core/assets/twgsl/twgsl.js', dest: 'static/lib/twgsl' },
                { src: 'node_modules/@babylonjs/core/assets/twgsl/twgsl.wasm', dest: 'static/lib/twgsl' },
